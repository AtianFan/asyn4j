...
import com.googlecode.asyn4j.core.work.*;
...
public class AsynServiceImpl extends ApplicationContext implements AsynService {
    private static Logger log = LoggerFactory.getLogger(AsynServiceImpl.class);
    // service run flag
	...
	public void close(long waitTime) {
		if (run) {
			...
			try {
				...
				log.error("asyn close exception:",e);
			}
    ...
    private Object newObject(Class clzss) {
        try {
            ...
            log.error("asyn new object exception:",e);
            return null;
        }
    }
    ...
    public void addAsynWork(AsynWork asynWork) {
        ...
        try {
            ...
            log.error("add asyn work exception:",e);
        }
